...
class BrewCask < Formula
  homepage 'https://github.com/gnuhub/homebrew-cask/'
  url 'https://github.com/gnuhub/homebrew-cask.git', :tag => "v#{HOMEBREW_CASK_VERSION}"

  head 'https://github.com/gnuhub/homebrew-cask.git', :branch => 'master'
